"""
Django settings for web3finance project.
...
SECRET_KEY = "django-insecure-34%kwc^%#uj!ke@9u3mihwsp^at8axlq$%fp_lxye%8r!n%4k$"
...
WSGI_APPLICATION = "web3finance.wsgi.application"
